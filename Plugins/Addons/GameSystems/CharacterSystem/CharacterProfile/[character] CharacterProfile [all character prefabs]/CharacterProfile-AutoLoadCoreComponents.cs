...
#if UNITY_EDITOR && DEBUG
<<<<<<< HEAD:Plugins/Addons/GameSystems/CharacterSystem/CharacterProfile/[character] CharacterProfile [all character prefabs]/CharacterProfile-CoreComponents.cs
            if (debugLog.ToString() != string.Empty) Debug.Log(DEBUG_CORE_PLUGINS_LOADED_MESSAGE + " - " + name
                + "\n" + " linked " + loadCounter + " components"
                + "\n" + debugLog.ToString());
=======
            if (debugLog.ToString() != string.Empty)
            {
                Debug.Log(DEBUG_CORE_PLUGINS_LOADED_MESSAGE + " - " + name
                    + "\n" + " linked " + loadCounter + " components"
                    + "\n" + debugLog.ToString());
            }
>>>>>>> master:Plugins/Addons/GameSystems/CharacterSystem/CharacterProfile/[character] CharacterProfile [all character prefabs]/CharacterProfile-AutoLoadCoreComponents.cs
#endif
            #endregion //DEBUG
        }
