...
namespace OpenMMO.Network
{
    public partial class NetworkManager
    {
        ...
        protected override bool RequestUserConfirm(string userName, string password) //ADDED - DX4D
        {
			...
			//debug.LogFormat(this.name, nameof(RequestUserConfirm), conn.Id(), userName); //DEBUG //REMOVED DX4D
